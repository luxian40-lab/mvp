...
def render_certificado_diseno_eki(
    *,
    ...
    url_verificacion='https://certificados.eki.technology/verificar-certificado/DEMO/',
    fecha_emision=None,
) -> BytesIO:
    ...
    try:
        ...
        qr.add_data(url_verificacion or 'https://certificados.eki.technology/verificar/')
        qr.make(fit=True)
