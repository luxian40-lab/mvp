...
MODULOS_GEI = [
    ...
    },
    {
        ...
        "contenido": (
            ...
            "CO₂ equivalente:\n\n"
            "🌱 Fertilizante (sintético): kg N × (0.01 + 0.001 + 0.00225) × 44/28 × 273 → kg CO₂e/año\n"
            "🌿 Fertilizante orgánico: kg × 1,6% N con factores reducidos\n"
            "⛽ Gasolina: galones × 7.62 | Diésel: galones × 10.28 → kg CO₂e/año\n"
            "💡 Energía: kWh/año × 0.126 (2026) o × 0.097 (2025) → kg CO₂e/año\n"
            "🍂 Residuos: ton × 1000 × factor según manejo (compost 0.19; suelo 0.026 kg/kg)\n"
