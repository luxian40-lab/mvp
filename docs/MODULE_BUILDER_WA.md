...
- Flag: `EKI_MODULE_BUILDER_BETA` (local settings.py → ON por defecto; prod → OFF salvo `=1`)
- Entrada visible: columna **Builder** en listado Módulos + botón **Module Builder** arriba del change form + enlace en guía Clase
- Tonos Mañana (cielo azul) / Tarde (lavanda) / Noche (ojos): barra fija abajo-derecha en **todo** el admin
...
- Desde ficha del módulo (guía): enlace “Abrir Module Builder” si el flag está ON
