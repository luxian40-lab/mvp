...
| **3** | Contexto agronómico Nati | `ContextoAgroSession`, `core/contexto_agro.py` |
...
## Parte 3 — Nati contexto agronómico (implementado)
...
- `crear_candidata_hitl()` — auto tras respuesta Nati técnica
