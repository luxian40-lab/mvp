#!/bin/bash
# Prueba Course Engine 15s â€” gate eki_wa_v1 + envÃ­o QA WhatsApp.
set -eu
...
TEL_QA="${TEL_QA:-573026480629}"
BRIEF="Tres claves de finanzas rurales para jovenes del campo: separa gastos, guarda un fondo de emergencia y registra cada peso que entra y sale de tu emprendimiento."
...
if not url:
    print("[WARN] Sin URL S3 â€” no se envia WA")
    sys.exit(0)
...
msg = (
    "[eki QA] Prueba Course Engine 15s â€” finanzas rurales. "
...
if not r.get("success"):
    ...
    sys.exit(1)
print("[OK] Prueba completada â€” revisa WhatsApp", tel[-10:])
PY
