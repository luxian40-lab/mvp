...
urlpatterns = [
    ...
    path('ir-a-aprende/', views.ir_a_aprende, name='studio_ir_a_aprende'),
    ...
    path('carrito/', views.carrito_ver, name='studio_carrito'),
    path('carrito/agregar/<int:publicacion_id>/', views.carrito_agregar, name='studio_carrito_agregar'),
    path('carrito/quitar/<int:item_id>/', views.carrito_quitar, name='studio_carrito_quitar'),
    path('carrito/checkout/', views.carrito_checkout, name='studio_carrito_checkout'),
    path('orden/<str:referencia>/', views.pagar_orden, name='studio_pagar_orden'),
    path('orden/<str:referencia>/resultado/', views.pagar_orden_resultado, name='studio_pagar_orden_resultado'),
    path('orden/<str:referencia>/confirmar/', views.pagar_orden_confirmar, name='studio_pagar_orden_confirmar'),
