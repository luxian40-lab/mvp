...
def main():
    try:
        ...
        try:
            ...
            logging.info("Estudiante de prueba creado correctamente.")
        except Exception as e:
            logging.exception("Error creando estudiante de prueba")
        ...
        for prueba in pruebas_agentes:
            try:
                ...
                logging.info(f"Agente {prueba['agente']} probado correctamente.")
            except Exception as e:
                logging.exception(f"Error en Agente{prueba['agente']}")
        ...
        try:
            ...
            logging.info("Sistema de logs verificado correctamente.")
        except Exception as e:
            logging.exception("Error verificando logs")
        ...
        try:
            ...
            logging.info("Sistema de envíos programados verificado correctamente.")
        except Exception as e:
            logging.exception("Error en envíos programados")
        ...
        logging.info("Prueba completa del sistema finalizada correctamente.")
    except Exception as e:
        logging.exception("Error global en la prueba completa del sistema")
        print(f"\n[ERROR GLOBAL] {e}\n")
        import traceback
        traceback.print_exc()
        sys.exit(1)
