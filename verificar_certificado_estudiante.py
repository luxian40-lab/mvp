...
def verificar_certificado_estudiante():
    try:
        print("=" * 70)
        ...
        logging.info("Verificación de certificados de estudiante ejecutada correctamente.")
    except Exception as e:
        logging.exception("Error en la verificación de certificados de estudiante")
        print(f"\n[ERROR] {e}\n")
        sys.exit(1)

if __name__ == "__main__":
    logging.basicConfig(level=logging.INFO, format='%(asctime)s %(levelname)s %(message)s')
    verificar_certificado_estudiante()
